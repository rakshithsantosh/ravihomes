      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Plots & Land</a></li>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p>info@nagarajhomes.com</p>
                  <p>sales@nagarajhomes.com</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm">
            © 2024 Nagaraj Homes. All rights reserved.
          </div>
          <div className="flex items-center space-x-6 mt-4 md:mt-0 text-sm text-gray-400">
            <span>RERA Registration: XXXXXXXX</span>
            <span>•</span>
            <span>License: XXXXXXXX</span>
          </div>
        </div>
      </div>
    </footer>
